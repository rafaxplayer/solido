...
add_action( 'after_setup_theme', 'solido_custom_header_setup' );

if ( ! function_exists( 'solido_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see solido_custom_header_setup().
	 */
	function solido_header_style() {
