...
$wp_customize->add_panel( 'solido_front_page_panel', array(
    'title' => esc_html__( 'Solido Template Landing Page', 'solido' ),
    'description' => esc_html__('This is setting for Landing Page Template','solido'),
    'priority' => 36,
    'active_callback' => 'solido_is_template_landing',
)); 
